...
export const generatedUpdateRegistrationSettingsSchema =
...
const updateRegistrationSettingsBaseSchema =
...
const registrationSettingsDateRefine = (data: {
  startDate?: Date | null
  endDate?: Date | null
}) => {
...
/**
 * Schema for updating registration settings (includes id)
 */
export const updateRegistrationSettingsSchema =
  updateRegistrationSettingsBaseSchema.refine(registrationSettingsDateRefine, {
    message: 'Start date must be before end date',
    path: ['endDate']
  })

/**
 * Body schema for PATCH (id comes from route params)
 */
export const updateRegistrationSettingsBodySchema =
  updateRegistrationSettingsBaseSchema
    .omit({ id: true })
    .refine(registrationSettingsDateRefine, {
      message: 'Start date must be before end date',
      path: ['endDate']
    })
