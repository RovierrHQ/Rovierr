  ...
  .group('/settings', (app) =>
        app
          .get(
            ...
            async ({ query, headers: elysiaHeaders }) => {
              ...
              if (!hasPermission) {
                throw new Error('You do not have permission to view registration settings')
              }
          ...
          .post(
            ...
            async ({ body, headers: elysiaHeaders }) => {
              ...
              if (existing) {
                throw new Error('Registration settings already exist for this society')
              }
          ...
          .get(
            ...
            async ({ params, headers: elysiaHeaders, user }) => {
              ...
              if (!(hasOrgPermission || isApplicant)) {
                throw new Error('You do not have permission to view this join request')
              }
          ...
          .post(
            ...
            async ({ params, headers: elysiaHeaders, user }) => {
              ...
              if (
                ...
                throw new Error('Join request cannot be approved in its current status')
              }
        ...
        app
            .post(
                ...
                async ({ params, body, headers: elysiaHeaders, user }) => {
                    ...
                    if (!hasPermission) throw new Error('You do not have permission to verify payments')
            ...
            .post(
                ...
                async ({ params, body, user }) => {
                    ...
                    if (request.userId !== user.id) {
                         throw new Error('You do not have permission to upload payment proof for this request')
                    }
            ...
            .post(
                ...
                async ({ body, headers: elysiaHeaders }) => {
                    ...
                    const hasPermission = await hasOrganizationUpdatePermission(
                     ...
                     if (!hasPermission) throw new Error('You do not have permission to generate QR codes')
                     
                     const society = await db.query.organization.findFirst({
                        where: eq(organization.id, body.societyId)
                     })
                     if (!society?.slug) throw new Error('Society not found or missing slug')
      ...
      .get(
        ...
        async ({ query, headers: elysiaHeaders }) => {
            ...
            if (!hasPermission) throw new Error('You do not have permission to view analytics')
            ...
            return {
                ...
                applicationsByStatus: [
                  ...
                  { status: 'payment_pending' as const, count: metrics.paymentPendingCount }
                ]
            }
        },
      ...
      .get(
        ...
        async ({ query, headers: elysiaHeaders }) => {
            ...
            if (!hasPermission) throw new Error('You do not have permission to export join requests')
