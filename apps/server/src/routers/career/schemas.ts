...
const insertJobApplicationSchema = createInsertSchema(jobApplication)
const selectJobApplicationSchema = createSelectSchema(jobApplication)
const updateJobApplicationSchema = createUpdateSchema(jobApplication)

// Resume Schemas
const insertResumeSchema = createInsertSchema(resume)
const selectResumeSchema = createSelectSchema(resume)
const updateResumeSchema = createUpdateSchema(resume)

// Cover Letter Schemas
const insertCoverLetterSchema = createInsertSchema(coverLetter)
const selectCoverLetterSchema = createSelectSchema(coverLetter)
const generatedUpdateCoverLetterSchema = createUpdateSchema(coverLetter)
 ...
 */
export const updateApplicationSchema = updateJobApplicationSchema
  .pick({
    id: true,
    companyName: true,
    positionTitle: true,
