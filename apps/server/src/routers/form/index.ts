      ...
      .post('/:id/duplicate', async ({ params, user }) => {
        ...
        try {
          ...
          if (error instanceof Error) {
            ...
            if (error.message === 'Unauthorized')
              throw new Error(
                'You do not have permission to duplicate this form'
              )
          }
          throw error
        }
          ...
          try {
            ...
            return {
              ...
              allowMultipleSubmissions:
                result.allowMultipleSubmissions ?? false,
              ...
              confirmationEmailEnabled:
                result.confirmationEmailEnabled ?? false,
              ...
              questions: result.questions.map((question) => ({
                ...
                conditionalLogicEnabled:
                  question.conditionalLogicEnabled ?? false,
                enableAutoFill: question.enableAutoFill ?? false,
                enableBidirectionalSync:
                  question.enableBidirectionalSync ?? false
              }))
            }
          } catch (error) {
            if (error instanceof Error) {
