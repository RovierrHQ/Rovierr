...
type ProfileDetails = {
  ...
  image?: string | null
  studentStatusVerified?: boolean | null
...
export function ProfileHero() {
  ...
  // TanStack Query v5 — single options object
  ...
  // Username — fall back to email prefix or sanitised display name
  const username =
  ...
  return (
    <div className="-mx-4 -mt-6 relative overflow-hidden">
      {/* ------------------------------------------------------------------ */}
      {/* Hero Banner                                                         */}
      {/* ------------------------------------------------------------------ */}
      <div className="relative h-64 w-full overflow-hidden">
        {profileDetails.bannerImage ? (
          // @unpic/react Image — layout="fullWidth" fills the container,
          // no need to pass explicit width/height
          <Image
            alt="Profile Banner"
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:items-start sm:gap-6">
            ...
            <div className="flex-1 space-y-3 pt-0 text-center sm:space-y-4 sm:pt-6 sm:text-left">
                ...
                <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
                  ...
                  {profileDetails.studentStatusVerified ? (
                    <TooltipProvider>
                      <Tooltip>
                        {/*
                          TooltipTrigger with asChild requires a single
                          focusable child. Wrap the div in a <button> so
                          Radix can forward the ref correctly and the
                          asChild prop is valid.
                        */}
                        <TooltipTrigger asChild>
                          <button
                            className="inline-flex cursor-pointer items-center gap-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-2.5 py-1 text-emerald-500 transition-colors hover:bg-emerald-500/15"
                            type="button"
                          >
                        ...
                        <TooltipContent className="max-w-xs" side="bottom">
                          <p className="text-sm">
                            This student&apos;s identity and enrollment have
                            been confirmed by{' '}
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            className="inline-flex cursor-pointer items-center gap-1.5 rounded-full border border-amber-500/30 bg-amber-500/10 px-2.5 py-1 text-amber-500 transition-colors hover:bg-amber-500/15"
                            type="button"
                          >
              ...
              {/* University / Faculty / Year badges */}
              <div className="flex flex-wrap items-center justify-center gap-2 sm:justify-start">
