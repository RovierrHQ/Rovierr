    ...
    <CardWrapper title="Review Your Information">
      <div className="space-y-3 text-gray-800">
        ...
        <div className="flex flex-wrap gap-2">
          {data.whatsapp && (
            <Tag icon={<CircleDashed size={14} />}>Whatsapp</Tag>
          )}
          {data.linkedin && (
            <Tag icon={<CircleDashed size={14} />}>LinkedIn</Tag>
          )}
          {data.instagram && (
            <Tag icon={<CircleDashed size={14} />}>Instagram</Tag>
          )}
          {data.wechat && <Tag icon={<CircleDashed size={14} />}>WeChat</Tag>}
...
function Tag({
  ...
  return (
    <div className="flex items-center gap-1 rounded-md bg-gray-100 px-3 py-1.5 font-medium text-sm">
