...
const sidebarSections: SidebarSection[] = [
  { id: 'groups', label: 'My Groups', icon: Users, href: '/social#groups' },
  {
    id: 'announcements',
    label: 'Announcements',
    icon: Megaphone,
  ...
  { id: 'events', label: 'Events', icon: Calendar, href: '/social#events' },
  {
    id: 'contacts',
    label: 'Contacts',
    icon: UserPlus,
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        <SpaceSidebar
          ...
          spaceColor="from-purple-500 to-pink-500"
        />
            ...
            <Card className="border-border bg-card p-6" id="announcements">
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-chart-1/20 bg-chart-1/5 p-3">
                  ...
                  <p className="text-muted-foreground text-xs">
                    This week's practice moved to 4:00 PM due to field
                    maintenance
                  </p>
                ...
                <div className="rounded-lg border border-border bg-card/50 p-4">
                  <div className="flex items-start gap-4">
                    <div className="flex flex-col items-center rounded-lg bg-chart-2/10 px-3 py-2">
                      ...
                      <span className="font-bold text-2xl text-chart-2">
                        16
                      </span>
                    </div>
                    <div className="flex-1">
                ...
                <div className="rounded-lg border border-border bg-card/50 p-4">
                  <div className="flex items-start gap-4">
                    <div className="flex flex-col items-center rounded-lg bg-chart-3/10 px-3 py-2">
                      ...
                      <span className="font-bold text-2xl text-chart-3">
                        18
                      </span>
                    </div>
                    <div className="flex-1">
            ...
            <Card className="border-border bg-card p-6" id="contacts">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-foreground text-sm">
                      <span className="font-medium">Emma</span> created a new
                      event
                    </p>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <p className="text-foreground text-sm">
                      <span className="font-medium">Lisa</span> commented on
                      your post
                    </p>
