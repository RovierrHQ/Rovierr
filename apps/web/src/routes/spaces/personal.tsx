...
export const Route = createFileRoute('/spaces/personal')({
...
function PersonalPage() {
  return (
    <main className="flex-1 px-6 py-8">
      <Card className="mb-8 p-6 border-blue-200 bg-blue-50/50 backdrop-blur-sm">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-blue-800 leading-relaxed">
              This feature is not connected to any backend database. The
              Personal Space will help you manage your finances and budget,
              track your health and workout goals, monitor your daily habits,
              and organize your personal life. All data shown is for demo
              purposes only.
            </p>
          </div>
        </div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-3">
          ...
          <h1 className="font-bold text-4xl text-foreground">Personal</h1>
        </div>
      ...
      <div className="mb-10 grid gap-6 md:grid-cols-4">
        <Card className="border-border bg-card p-6 transition-all duration-200 hover:shadow-lg hover:-translate-y-1">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-muted-foreground text-sm">Monthly Budget</p>
              <p className="mt-1 font-bold text-3xl text-foreground">$2,450</p>
            </div>
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        {/* Finance Management */}
        <Card
          className="border-border bg-card p-8 lg:col-span-2 shadow-sm"
          id="finance"
        >
          ...
          <div className="mb-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-lg border border-border bg-card/50 p-4">
              ...
              <p className="mt-1 font-bold text-2xl text-foreground">$8,450</p>
            ...
            <div className="rounded-lg border border-border bg-card/50 p-4">
              ...
              <p className="mt-1 font-bold text-2xl text-foreground">$3,200</p>
            ...
            <div className="rounded-lg border border-border bg-card/50 p-4">
              ...
              <p className="mt-1 font-bold text-2xl text-foreground">$2,150</p>
            ...
            <div className="rounded-lg border border-border bg-card/50 p-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-foreground">Rent Payment</p>
                    <p className="text-muted-foreground text-xs">Dec 1, 2024</p>
                  </div>
                </div>
          ...
          <div className="space-y-4">
            <div>
              <div className="mb-2 flex justify-between">
                <span className="text-muted-foreground text-sm">Housing</span>
            ...
            <div className="mt-6 rounded-lg border border-chart-2/20 bg-chart-2/5 p-4">
              ...
              <p className="mt-1 font-bold text-2xl text-foreground">$785</p>
            </div>
          </div>
        </Card>

        {/* Health & Wellness */}
        <Card className="border-border bg-card p-6 lg:col-span-2" id="health">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="rounded-lg border border-border bg-card/50 p-4">
              <div className="mb-3 flex items-center gap-3">
                ...
                <div>
                  <p className="font-medium text-foreground">Workout Streak</p>
                  <p className="text-muted-foreground text-xs">
                    12 days in a row
                  </p>
                </div>
            ...
            <div className="rounded-lg border border-border bg-card/50 p-4">
              <div className="mb-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-xs">7.5 hours avg</p>
                </div>
              </div>
              <p className="text-muted-foreground text-sm">
        ...
        {/* Living Essentials */}
        <Card className="border-border bg-card p-6 lg:col-span-3" id="living">
          <div className="mb-6 flex items-center justify-between">
            <h3 className="font-semibold text-foreground text-lg">
              Living Essentials
            </h3>
