...
export const Route = createFileRoute('/spaces/societies/mine/')({
  component: MySocietiesPage
})
              ...
              <CardContent className="flex flex-col items-center justify-center py-12">
                ...
                <div className="flex gap-2">
                  <Button variant="outline">
                    <Link to="/spaces/societies/discover/browse-clubs">
                      Browse Societies
                    </Link>
                  </Button>
                  <Button>
                    <Link to="/spaces/societies/create">Create Society</Link>
                  </Button>
                </div>
              </CardContent>
            </Card>
