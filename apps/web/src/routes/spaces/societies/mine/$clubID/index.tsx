...
function ClubProfileLoadingSkeleton() {
  return (
...
function ClubProfilePage() {
  ...
  if (isPending) {
    return <ClubProfileLoadingSkeleton />
  }
    ...
    <div className="mx-auto min-h-screen max-w-5xl">
      <div className="-mx-4 -mt-6 relative overflow-x-hidden">
        <ClubBanner
          ...
          onBannerClick={() => setIsBannerDialogOpen(true)}
          society={society}
        />
